  ...
  return new Promise((resolve, reject) => {
    this.discoveryClient.listEnvironments(params, (err, data) => {
      if (err) {
        ...
        console.log('Discovery environment: ');
        ...
        console.log('Did NOT find existing Discovery environment to use. Proceed to create. ');
        return resolve(params);
      }
    });
  });
...
WatsonDiscoverySetup.prototype.createDiscoveryEnvironment = function(params) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const createParams = {
      ...
      size: 'M' // Use string to avoid default of 1.
    };
